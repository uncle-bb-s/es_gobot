...
def user_commands_hint():
    return (
        ...
        "• /info — список всех актуальных блоков 🌐"
    )
...
# Остальные админ-команды (/setchat, /addbot, /removebot, /addsite, /removesite, /settings, /broadcast) остаются точно как в исходном коде
